...
helpers.sendMailGeneral = async function(link, userInfo, type){
    try{
        var mailSubject= (type=="resetPass")
        ?`Please Confirm you email ${userInfo.firstName} and Reset your Password`
        :`Please Confirm you email ${userInfo.firstName}`;
        var buttonText = (type=="resetPass")?"Reset Password":"Continue Registration";
        //Mail Style
        const pageWrapper = `
        line-height: 1.5rem;
        display: table;
            ...
            <tr style="${tblRow}">
                <td>
                    <table style="${frmWrapper}">
                        ...
                        <tr style="${tblRow}">
                            <td style="${frmButton}">
                                <a style="${formButton}" href="${link}" target="_blank">${buttonText}</button>
                            </td>
                        </tr>
                    </table>
                </td>
